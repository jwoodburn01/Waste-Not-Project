...
// for this i used MD Bootstrap to help me with the footer
          ...
          <MDBRow className="mt-3">
            ...
            <MDBCol md="4" lg="3" xl="3" className="mx-auto mb-md-0 mb-4">
              ...
              <p>
                ...
                {/* I have just used the CSB as the location  */}
                <a
                  className="text-reset"
                  href="https://www.google.com/maps/place/Computer+Science+Building/@54.5816952,-5.9402296,17z/data=!3m2!4b1!5s0x486108ee841fa375:0x1e7977a7dfee6774!4m6!3m5!1s0x486108ee869f9ea9:0xa9f41c9563d671de!8m2!3d54.5816921!4d-5.9376547!16s%2Fg%2F1hc2rj0vr?hl=en&entry=ttu"
                >
                  Belfast BT9 5BN
                </a>
              </p>
              <p>
                ...
                {/* I have used a mail to for the contact us, it will use the waste not email address */}
                <a
                  href=""
                  onClick={() =>
                    (window.location.href = `mailto:wastenot@wn.com`)
                  }
                  className="text-reset"
                >
                  wastenot@wn.com
